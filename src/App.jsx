...
const obj4 = [
  ...
  return (
    <>
      ...
      <Toggle />
      <hr></hr>
      <h1>Multiple Conditional Rendering in React</h1>
      <h1>{counter}</h1>
      <button onClick={() => setCounter(counter + 1)}>Counter</button>
      {counter == 0 ? (
        <h1>condition is Zero </h1>
      ) : counter == 1 ? (
        <h1>condition is One</h1>
      ) : counter == 2 ? (
        <h1>condition is Two</h1>
      ) : counter == 3 ? (
        <h1>condition is Three</h1>
      ) : (
...
//components
function Apple() {
  return <h1>This is Apple Component</h1>;
}
function Banana() {
  return <h1>This is Banana Component</h1>;
}
//function
